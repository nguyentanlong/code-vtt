    ...
    <body>
        <form id="form1" runat="server">
            <div class="otp-card text-center">
                ...
                <p class="text-muted small mb-3">Mã xác thực đã được gửi tới email:<br /><b id="lblEmail"
                        runat="server">***@gmail.com</b></p>
                ...
                <div class="mb-3">
                    <input type="text" id="txtOTP" class="form-control otp-input" maxlength="6" placeholder="******"
                        autocomplete="off" />
                </div>

                <button type="button" id="btnVerify" class="btn btn-primary w-100 py-2 fw-semibold mb-3">Xác thực & Đăng
                    nhập</button>

                <!-- Khu vực Gửi lại mã kèm đếm ngược 60s -->
                <div class="resend-box mb-2">
                    <span>Chưa nhận được mã? </span>
                    <button type="button" id="btnResend" class="btn btn-link p-0 text-decoration-none fw-semibold"
                        disabled>
