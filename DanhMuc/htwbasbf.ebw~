<%@ Page Title="Quản lý Nhân Viên" Language="C#" MasterPageFile="~/DanhMuc/child.Master" AutoEventWireup="true" CodeBehind="nhan-vien.aspx.cs" Inherits="VTT.DanhMuc.nhan_vien" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../assets/css/selects.css?v=<% Response.Write(VTT.libs.libs.randomVersion()); %>" rel="stylesheet" />
    <link href="../assets/css/danh-muc/nhan-vien.css?v=<% Response.Write(VTT.libs.libs.randomVersion()); %>" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card-body">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="input-group">
                        <input type="text" id="txtSearch" class="form-control" placeholder="Nhập mã hoặc tên nhân viên..." />
                        <button type="button" id="btnSearch" class="btn btn-primary" onclick="loadData(); return false;">
    ...
    <div class="modal fade" id="modalNhanVien" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-3">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-bold" for="chkTrangThai">Đang làm việc (Hoạt động)</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light py-2">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa fa-times me-1"></i>Hủy</button>
                    <button type="button" class="btn btn-primary" id="btnSave"><i class="fa fa-save me-1"></i>Lưu Dữ Liệu</button>
                </div>
            </div>
        </div>
    </div>
