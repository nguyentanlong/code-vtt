<%@ Page Title="Quản lý Phòng Ban" Language="C#" MasterPageFile="~/DanhMuc/child.Master" AutoEventWireup="true" CodeBehind="phong-ban.aspx.cs" Inherits="VTT.DanhMuc.phong_ban" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card mb-3 shadow-sm">
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div class="d-flex gap-2 align-items-center flex-grow-1">
                    <input type="text" id="txtKeyword" class="form-control" style="max-width: 300px;" placeholder="Tìm theo mã, tên phòng..." />
                    ...
                    <form id="frmPhongBan" onsubmit="return false;">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="txtMaPhongBan" class="form-control" placeholder="Mã PB..." required />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required">Tên phòng ban</label>
                                <input type="text" id="txtTenPhongBan" class="form-control" placeholder="Tên PB..." required />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="txtTruongPhongID" class="form-control" placeholder="Mã NV làm trưởng phòng" />
                            </div>
                            <div class="col-md-6">
    ...
    <!-- SCRIPT REFERENCE -->
    <script src="../assets/js/danh-muc/phong-ban.js?v=<% Response.Write(VTT.libs.libs.randomVersion()); %>"></script>
</asp:Content>