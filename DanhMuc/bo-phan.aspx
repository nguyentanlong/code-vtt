            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="d-flex gap-2 align-items-center flex-grow-1">
                        ...
                        <select id="ddlFilterPhongBan" class="form-select" style="max-width: 280px;"
                            onchange="loadData()">
                            <!-- Dropdown load từ danh sách phòng ban -->
                        </select>

                        <input type="text" id="txtKeyword" class="form-control ms-2" style="max-width: 250px;"
                        ...
                        <form id="frmBoPhan" onsubmit="return false;">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="clSelect" id="chonTruongBoPhan" data-value="NhanVienID"
                                        data-member="TenHienThi" data-default="-1" data-link="">
                                    </div>
                                </div>
                                <div class="col-md-6">
