<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="VTT.login" %>
        ...
        <div class="login-card">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="txtUsername" placeholder="Nhập Username..." autocomplete="username" required />
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control password-field" id="txtPassword" placeholder="Nhập Mật khẩu..." autocomplete="current-password" required />
